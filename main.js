...
//var roleCustomBuilder = require('role.custombuilder');
...
module.exports.loop = function () {
    ...
    if (harvester < nbHarvester) {//[MOVE, MOVE, CARRY, CARRY, WORK, WORK, WORK, MOVE]
        var result = Game.spawns["Spawn1"].createCreep([MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, WORK, WORK, WORK, WORK], undefined, {role:"harvester"});
    ...
    if (builder < nbBuilder) {//[MOVE, CARRY, WORK, WORK]
        var result = Game.spawns["Spawn1"].createCreep([MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, WORK, WORK, WORK, WORK], undefined, {role:"builder"});
        if(_.isString(result)) {
